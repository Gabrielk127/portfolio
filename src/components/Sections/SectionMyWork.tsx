        ...
        <div className="md:hidden">
          ...
          <div className="flex justify-center">
            <a
              ...
              rel="noopener noreferrer"
            >
              <div className="flex flex-row items-center gap-2 bg-black bg-opacity-30 backdrop-blur-lg shadow-lg py-3 px-6 rounded-full text-white border border-zinc-800 text-sm w-full max-w-48 justify-center my-4">
                <p>Acessar Projeto</p>
                <FiArrowRight />
              </div>
            </a>
